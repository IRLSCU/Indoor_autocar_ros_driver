...
if("TRUE" STREQUAL "TRUE")
  set(TL740D_SOURCE_PREFIX /home/zhao/Data/AutoD/temp/src/TL740D)
  set(TL740D_DEVEL_PREFIX /home/zhao/Data/AutoD/temp/src/TL740D/cmake-build-debug/devel)
  set(TL740D_INSTALL_PREFIX "")
  set(TL740D_PREFIX ${TL740D_DEVEL_PREFIX})
else()
  set(TL740D_SOURCE_PREFIX "")
  set(TL740D_DEVEL_PREFIX "")
  set(TL740D_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/zhao/Data/AutoD/temp/src/TL740D/include " STREQUAL " ")
  set(TL740D_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhao/Data/AutoD/temp/src/TL740D/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'TL740D' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhao/Data/AutoD/temp/src/TL740D/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhao/Data/AutoD/temp/src/TL740D/cmake-build-debug/devel/lib;/opt/ros/kinetic/lib)
